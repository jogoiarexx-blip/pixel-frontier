...
import { assetSheetSprite, sprite } from "./pixelArt";
import type { CharacterData, PixelPart } from "./types";
...
export function explorerSprite(scene: Scene, data: CharacterData, name: string) {
...
export function sentrySprite(scene: Scene, name: string) {
  return assetSheetSprite(scene, name, assetUrl("soldier_sheet.png"), 8, 2.75, 2.75, 0, 0.06);
}

export function droneSprite(scene: Scene, name: string) {
...
export function rescueSprite(scene: Scene, name: string) {
  return sprite(scene, name, [
...
export function roverSprite(scene: Scene, name: string) {
...
export function bossSprite(scene: Scene, name: string) {
  return assetSheetSprite(scene, name, assetUrl("boss_argo_sheet.png"), 6, 7.0, 4.65, 0, 0.10);
}

export function enemyJeepSprite(scene: Scene, name: string) {
  const root = sprite(scene, name, [
...
export function attackHelicopterSprite(scene: Scene, name: string) {
  return sprite(scene, name, [
